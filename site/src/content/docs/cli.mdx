...
|--------|------|-------------|
| `--name` | string | Rename the project (project-admin only). Available starting v0.12.1. |
...
| Option | Type | Description |
|--------|------|-------------|
| `--for` | string | Target tool: `claude-code`, `codex`, `gemini`, `cursor`, `copilot`, `amp`, `cline`, `roo-code`, `kilo-code` |
