...
Manage SessionFS hooks for tools with native hook support. v0.9.9.12 supports Claude Code only. See [Hook-based injection](/docs/rules/#hook-based-injection-claude-code) for the full reference.
...
| Option | Type | Default | Description |
|--------|------|---------|-------------|
| `--for` | string | required | Target tool (`claude-code` only in v0.9.9.12) |
