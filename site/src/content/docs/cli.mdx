...
Manage SessionFS hooks for tools with native hook support. v0.9.9.9 supports Claude Code only. See [Hook-based injection](/docs/rules/#hook-based-injection-claude-code) for the full reference.
