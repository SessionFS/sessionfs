...
Hook-based injection requires native hook support in the AI tool. As of v0.9.9.9, Claude Code is the only supported tool with that capability. File-based compile remains the universal path for codex, cursor, copilot, and gemini.
</Aside>
