...
- [External Agent Orchestration](/integrations/external-agents) — wrap a spawned Codex/Gemini/Claude Code CLI agent in an AgentRun (same record, orchestrator-initiated instead of CI-gated).
