...
- **No scoped service tokens.** Use your existing Bearer API key (the same one `sfs auth login` set up). Scoped service tokens for CI runners are a deferred follow-up.
