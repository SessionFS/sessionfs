...
The MCP server exposes 36 tools in six categories: Session, Knowledge Read, Knowledge Write, Rules, Personas (Pro+), and Tickets (Team+).
...
Open a new ticket. Agent-created tickets require ≥1 acceptance criterion + ≥20-char description; max 3 per `session_id`.
