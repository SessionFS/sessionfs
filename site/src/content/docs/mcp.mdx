...
The MCP server exposes 58 tools in eight categories: Session, Knowledge Read, Knowledge Write, Rules, Personas (Pro+), Tickets (Team+), AgentRun (Team+), and Handoffs (Pro+ for direct, Team+ for team handoffs).
